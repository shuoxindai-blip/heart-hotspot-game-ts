# Heart Anatomy Challenge

React + TypeScript + Tailwind implementation of the Heart Anatomy Challenge.
...
- `src/data/heartGame.ts` contains the current heart hotspot question set.
